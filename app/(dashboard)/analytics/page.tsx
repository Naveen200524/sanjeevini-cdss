    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold text-slate-800">Oncology Analytics</h1>
                    <p className="text-slate-500 text-sm">Oncology care performance and financial insights dashboard.</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <GlassCard className="p-6">
                    <p className="text-sm font-medium text-slate-500">Oncology Predictions Served</p>
                    <div className="mt-2 flex items-baseline gap-2">
                ...
                <GlassCard className="p-6">
                    <p className="text-sm font-medium text-slate-500">Avg. Cancer Risk Reduction</p>
                    <div className="mt-2 flex items-baseline gap-2">
